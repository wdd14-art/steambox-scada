/* ============================================================================
   STEAMBOX 30 UNIT DASHBOARD JAVASCRIPT LOGIC - VERSION v37 (FINAL BUGFIX)
   - Solved: Removed Window.PopSubByNo(120) to prevent native Haiwell popup
   - Safe Read-only SCADA Memory Resolution (Zero Object Mutation)
   - Exact physical tag write dispatching via Variable.SetById
   ============================================================================ */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Default Master Recipe Database
    let masterRecipes = [
    ...
    function selectRecipeForUnit(recipe) {
        ...
        // 3. Trigger Recipe Transfer Task in SCADA ($sb_X.trf_resep = 1)
        setTagValue(`sb_${id}.trf_resep`, 1);
        setTagValue(`sb_${id}_trf_resep`, 1);

        // NOTE: Panggilan PopSubByNo(120) sengaja DIBUANG agar tidak memicu popup native Haiwell
